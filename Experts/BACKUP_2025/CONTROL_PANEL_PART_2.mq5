...
int OnInit() {
   ...
   obj_Lbl_HEADER.Color(clrBlue); //--- Set text color of the header label
   ...
   //obj_Btn_FOOTER.Text("https://t.me/Forex_Algo_Trader"); //--- Set text of the footer button with a link
